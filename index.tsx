...
const styles = `
  ...
  * {
  ...
  @keyframes splashSlideFromRight {
    from { opacity: 0; transform: translateX(50px); }
    to { opacity: 1; transform: translateX(0); }
  }
  @keyframes splashSlideFromLeft {
    from { opacity: 0; transform: translateX(-50px); }
    to { opacity: 1; transform: translateX(0); }
  }
  ...
  .splash-text-right-to-left {
    animation: splashSlideFromRight 0.8s ease-out forwards;
  }
  .splash-text-left-to-right {
    animation: splashSlideFromLeft 0.8s ease-out forwards;
  }
  .splash-exit {
...
// Menu State Context for sharing header/menu state with other components
interface MenuStateContextType {
  collectionsMenuOpen: boolean;
  setCollectionsMenuOpen: (open: boolean) => void;
}
...
const productsData: Product[] = [
  // BED - Bedsheets
  {
    ...
    category: "Bedsheet",
    material: "100% Cotton",
    fabric: "Percale Weave",
    color: "Multi Floral",
    dimensions: "King Size - 274 × 274 CM",
    technique: "Rotary Print",
    careNotes: "Machine wash cold. Tumble dry low.",
    description: "Beautiful floral print bedsheet in vibrant colors. Part of our 20-design print collection.",
    inStock: true
  },
  {
    id: 2,
    name: "Solid Bedsheet - Navy",
    price: 1799,
    ...
    careNotes: "Machine wash cold. Do not bleach.",
    description: "Premium solid color bedsheet available in 15 elegant shades.",
    inStock: true
  },
  {
    id: 3,
    name: "Digital Print Bedsheet - Geometric",
    price: 2499,
    ...
    fabric: "300 Thread Count",
    color: "Geometric Multi",
    dimensions: "King Size - 274 × 274 CM",
    technique: "Digital Print",
    careNotes: "Gentle machine wash. Iron on reverse.",
    description: "High-definition digital print bedsheet with modern geometric patterns.",
    inStock: true
  },
  {
    id: 4,
    name: "Yarn Dyed Bedsheet - Stripes",
    price: 2999,
    ...
    fabric: "Yarn Dyed Weave",
    color: "Classic Stripes",
    dimensions: "King Size - 274 × 274 CM",
    technique: "Yarn Dyed",
    careNotes: "Machine wash warm. Colors won't fade.",
    description: "Premium yarn dyed bedsheet with classic stripe pattern that never fades.",
    inStock: true
  },
  {
    id: 5,
    name: "Embroidery Bedsheet - Paisley",
    price: 3499,
    ...
    fabric: "400 Thread Count",
    color: "Ivory with Gold",
    dimensions: "King Size - 274 × 274 CM",
    technique: "Machine Embroidery",
    careNotes: "Dry clean recommended.",
    description: "Elegant embroidered bedsheet with intricate paisley border design.",
    inStock: true
  },
  // BED - Comforter & Dohar
  {
    id: 6,
    name: "Premium Comforter - Cloud White",
    price: 4999,
    ...
    fabric: "Cotton Shell",
    color: "Cloud White",
    dimensions: "King Size - 230 × 250 CM",
    technique: "Box Stitch",
    careNotes: "Machine washable. Tumble dry low.",
    description: "Lightweight yet warm comforter perfect for all seasons.",
    inStock: true
  },
  {
    id: 7,
    name: "Cotton Dohar - Summer Breeze",
    price: 1999,
    priceFormatted: "₹ 1,999",
    image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=800",
    images: [
    ...
    category: "Dohar",
    material: "100% Cotton",
    fabric: "3-Layer Muslin",
    color: "Sky Blue",
    dimensions: "Double - 220 × 240 CM",
    technique: "Layered Construction",
    careNotes: "Machine wash gentle. Air dry recommended.",
    description: "Light and breathable cotton dohar ideal for summer nights.",
    inStock: true
  },
  {
    id: 8,
    name: "Fleece Blanket - Cozy Grey",
    price: 1499,
    ...
    fabric: "Anti-Pilling",
    color: "Charcoal Grey",
    dimensions: "Double - 200 × 220 CM",
    technique: "Double-Sided",
    careNotes: "Machine wash cold. Do not iron.",
    description: "Super soft fleece blanket for cozy winter evenings.",
    inStock: true
  },
  // BED - Pillows
  {
    id: 9,
    name: "Fern Pillow - Cotton Comfort",
    price: 799,
    priceFormatted: "₹ 799",
    ...
    fabric: "Microfiber Fill",
    color: "White",
    dimensions: "17 × 27 IN",
    technique: "Box Construction",
    careNotes: "Spot clean. Air fluff regularly.",
    description: "Fern collection pillow with premium cotton cover for everyday comfort.",
    inStock: true
  },
  {
    id: 10,
    name: "Dove Pillow - Peach Soft",
    price: 999,
    priceFormatted: "₹ 999",
    image: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&q=80&w=800",
    images: [
    ...
    category: "Pillow",
    material: "100% Peach Fabric",
    fabric: "Hollow Fiber Fill",
    color: "Peach White",
    dimensions: "17 × 27 IN",
    technique: "Quilted Top",
    careNotes: "Machine washable cover.",
    description: "Dove collection pillow with ultra-soft peach fabric exterior.",
    inStock: true
  },
  {
    id: 11,
    name: "Swan Pillow - Memory Foam",
    price: 1999,
    priceFormatted: "₹ 1,999",
    image: "https://images.unsplash.com/photo-1584100936595-c0654b55a2e6?auto=format&fit=crop&q=80&w=800",
    images: [
    ...
    color: "Natural White",
    dimensions: "17 × 27 IN",
    technique: "Contour Design",
    careNotes: "Removable washable cover. Do not wash foam.",
    description: "Swan collection bamboo memory foam pillow for orthopedic support.",
    inStock: true
  },
  {
    id: 12,
    name: "Canary Pillow Combo - Set of 2",
    price: 1599,
    ...
    fabric: "Microfiber Fill",
    color: "White",
    dimensions: "17 × 27 IN (Set of 2)",
    technique: "Soft Touch",
    careNotes: "Machine washable.",
    description: "Canary collection combo pack - great value set of 2 pillows.",
    inStock: true
  }
];
...
const ProductModal = ({ product, onClose }: { product: Product, onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[6000] flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-fadeIn">
      <div className="bg-white max-w-5xl w-full grid md:grid-cols-2 shadow-2xl animate-scaleIn max-h-[90vh] overflow-y-auto relative rounded-lg">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 p-2 bg-white/80 rounded-full hover:bg-white text-gray-500 hover:text-[#9f1b3c] transition-colors"
        >
          <X size={24} />
        </button>

        <div className="h-64 md:h-auto bg-gray-50 relative">
        ...
        <div className="p-6 md:p-16 flex flex-col justify-center">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h3 className="font-redhat font-bold text-3xl md:text-4xl text-[#064770]">{product.name}</h3>
            </div>
          </div>
          <p className="font-garamond text-xl md:text-2xl italic text-gray-500 mb-8 font-light">{product.category || "Experience the luxury of fine craftsmanship."}</p>
          <div className="space-y-4 mb-10">
            <p className="font-source text-gray-600 leading-relaxed text-base md:text-lg font-light">
              {product.description || "Expertly crafted from the finest materials, this piece exemplifies Arvind's commitment to quality and sustainable innovation."}
            </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-auto">
            <button
              onClick={handleAddToCart}
              className="button-primary w-full sm:flex-1 flex items-center justify-center gap-3"
            >
              <ShoppingBag size={16} />
              Add to Cart
            </button>
            <button className="w-full sm:w-auto px-8 py-3.5 border border-gray-300 text-gray-600 font-source font-semibold uppercase text-xs tracking-widest hover:border-[#9f1b3c] hover:text-[#9f1b3c] transition-colors text-center">
              Details
            </button>
          </div>
        </div>
...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 w-full z-[8000] transition-all duration-300 ${scrolled || isLightPage ? 'bg-white shadow-sm' : 'bg-transparent'} ${hidden ? '-translate-y-full' : 'translate-y-0'}`}
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-4">
            <div className="flex items-center justify-between h-12">
              ...
              <nav className="hidden md:flex items-center gap-6 justify-start">
                ...
                <div
                  className="relative"
                  onMouseEnter={() => { setMegaMenuOpen(true); setCollectionsMenuOpen(false); }}
                  onMouseLeave={() => setMegaMenuOpen(false)}
                >
                ...
                <Link
                  ...
                  onMouseEnter={() => { setMegaMenuOpen(false); setCollectionsMenuOpen(false); }}
                >
                  SHOP
                </Link>
              </nav>
              ...
              >
                {mobileMenuOpen ? <X className="text-[#2c2c2c]" size={24} /> : <Menu className={scrolled ? 'text-[#2c2c2c]' : 'text-white'} size={24} />}
              </button>
            </div>
          </div>
        </div>

        {/* BED Mega Menu Dropdown */}
        <div
          className={`absolute left-0 top-full w-full bg-[#FDFBF7] border-t border-gray-100 shadow-lg transition-all duration-300 overflow-hidden ${megaMenuOpen ? 'max-h-[600px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}
          onMouseEnter={() => { setMegaMenuOpen(true); setCollectionsMenuOpen(false); }}
          onMouseLeave={() => setMegaMenuOpen(false)}
        >
          <div className="max-w-[1400px] mx-auto px-12 py-10">
            <div className="grid grid-cols-5 gap-8">
              {/* Bedsheet */}
              <div>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4">Bedsheet</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/bedsheet-print" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors flex justify-between" onClick={() => setMegaMenuOpen(false)}>Print <span className="text-gray-400">(20)</span></Link></li>
                  <li><Link to="/shop/bedsheet-solid" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors flex justify-between" onClick={() => setMegaMenuOpen(false)}>Solid <span className="text-gray-400">(15)</span></Link></li>
                  <li><Link to="/shop/bedsheet-digital" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors flex justify-between" onClick={() => setMegaMenuOpen(false)}>Digital Print <span className="text-gray-400">(5)</span></Link></li>
                  <li><Link to="/shop/bedsheet-yarn" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors flex justify-between" onClick={() => setMegaMenuOpen(false)}>Yarn Dyed <span className="text-gray-400">(1)</span></Link></li>
                  <li><Link to="/shop/bedsheet-embroidery" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors flex justify-between" onClick={() => setMegaMenuOpen(false)}>Embroidery <span className="text-gray-400">(2)</span></Link></li>
                </ul>
              </div>

              {/* Comforter & Dohar */}
              <div>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4">Comfort</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/comforter" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Comforter</Link></li>
                  <li><Link to="/shop/dohar" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Dohar</Link></li>
                  <li><Link to="/shop/blanket" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Blanket</Link></li>
                  <li><Link to="/shop/duvet-cover" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Duvet Cover</Link></li>
                </ul>
              </div>

              {/* Pillow & Covers */}
              <div>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4">Pillow</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/pillow-fern" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Fern</Link></li>
                  <li><Link to="/shop/pillow-dove" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Dove</Link></li>
                  <li><Link to="/shop/pillow-canary" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Canary</Link></li>
                  <li><Link to="/shop/pillow-swan" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Swan</Link></li>
                </ul>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4 mt-6">Accessories</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/pillow-covers" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Pillow Covers</Link></li>
                  <li><Link to="/shop/mosquito-net" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setMegaMenuOpen(false)}>Mosquito Net</Link></li>
                </ul>
              </div>

              {/* Featured Image 1 */}
              <div className="group cursor-pointer" onClick={() => { navigate('/shop/bedsheet'); setMegaMenuOpen(false); }}>
                <div className="aspect-[4/3] overflow-hidden bg-gray-100 mb-4">
                  <img src="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=400" alt="Bedsheet Collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <h4 className="font-source text-sm uppercase tracking-wider text-[#2c2c2c] group-hover:text-[#9f1b3c] transition-colors">NEW BEDSHEETS</h4>
              </div>

              {/* Featured Image 2 */}
              <div className="group cursor-pointer" onClick={() => { navigate('/shop/comforter'); setMegaMenuOpen(false); }}>
                <div className="aspect-[4/3] overflow-hidden bg-gray-100 mb-4">
                  <img src="https://images.unsplash.com/photo-1615529182904-14819c35db37?auto=format&fit=crop&q=80&w=400" alt="Comforter Collection" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <h4 className="font-source text-sm uppercase tracking-wider text-[#2c2c2c] group-hover:text-[#9f1b3c] transition-colors">COMFORTERS</h4>
              </div>
            </div>
          </div>
        </div>

        {/* BATH Mega Menu Dropdown */}
        <div
          className={`absolute left-0 top-full w-full bg-[#FDFBF7] border-t border-gray-100 shadow-lg transition-all duration-300 overflow-hidden ${collectionsMenuOpen ? 'max-h-[600px] opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}
          onMouseEnter={() => { setCollectionsMenuOpen(true); setMegaMenuOpen(false); }}
          onMouseLeave={() => setCollectionsMenuOpen(false)}
        >
          <div className="max-w-[1400px] mx-auto px-12 py-10">
            <div className="grid grid-cols-4 gap-8">
              {/* Bath Towel */}
              <div>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4">Bath Towel</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/bath-towel-honeydew" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Honey Dew</Link></li>
                  <li><Link to="/shop/bath-towel-jasmine" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Jasmine</Link></li>
                  <li><Link to="/shop/bath-towel-daffodil" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Daffodil</Link></li>
                  <li><Link to="/shop/bath-towel-orchid" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Orchid</Link></li>
                </ul>
              </div>

              {/* Other Towels */}
              <div>
                <h3 className="font-source font-bold text-sm uppercase tracking-wider text-[#9f1b3c] mb-4">Towels</h3>
                <ul className="space-y-2">
                  <li><Link to="/shop/baby-bath-towel" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Baby Bath Towel</Link></li>
                  <li><Link to="/shop/hand-towel" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Hand Towel</Link></li>
                  <li><Link to="/shop/face-towel" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Face Towel</Link></li>
                  <li><Link to="/shop/towel-combo" className="font-source text-sm text-gray-600 hover:text-[#9f1b3c] transition-colors" onClick={() => setCollectionsMenuOpen(false)}>Combo</Link></li>
                </ul>
              </div>

              {/* Featured Image 1 */}
              <div className="group cursor-pointer" onClick={() => { navigate('/shop/bath-towel'); setCollectionsMenuOpen(false); }}>
                <div className="aspect-[4/3] overflow-hidden bg-gray-100 mb-4">
                  <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=400" alt="Bath Towels" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <h4 className="font-source text-sm uppercase tracking-wider text-[#2c2c2c] group-hover:text-[#9f1b3c] transition-colors">BATH TOWELS</h4>
              </div>

              {/* Featured Image 2 */}
              <div className="group cursor-pointer" onClick={() => { navigate('/shop/towel-combo'); setCollectionsMenuOpen(false); }}>
                <div className="aspect-[4/3] overflow-hidden bg-gray-100 mb-4">
                  <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=400" alt="Towel Combo" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                <h4 className="font-source text-sm uppercase tracking-wider text-[#2c2c2c] group-hover:text-[#9f1b3c] transition-colors">TOWEL COMBOS</h4>
              </div>
            </div>
      ...
      <div className={`fixed inset-0 bg-white z-[4000] transition-transform duration-500 transform ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden pt-24 px-6 overflow-y-auto`}>
        <div className="flex flex-col gap-6">
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#9f1b3c] mb-4">BED</h3>
            <Link to="/shop/bedsheet" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Bedsheet</Link>
            <Link to="/shop/comforter" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Comforter</Link>
            <Link to="/shop/dohar" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Dohar</Link>
            <Link to="/shop/blanket" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Blanket</Link>
            <Link to="/shop/pillow" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Pillow</Link>
            <Link to="/shop/pillow-covers" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Pillow Covers</Link>
            <Link to="/shop/mosquito-net" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Mosquito Net</Link>
            <Link to="/shop/duvet-cover" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Duvet Cover</Link>
          </div>
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wider text-[#9f1b3c] mb-4">BATH</h3>
            <Link to="/shop/bath-towel" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Bath Towel</Link>
            <Link to="/shop/baby-bath-towel" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Baby Bath Towel</Link>
            <Link to="/shop/hand-towel" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Hand Towel</Link>
            <Link to="/shop/face-towel" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Face Towel</Link>
            <Link to="/shop/towel-combo" className="block py-3 text-lg font-semibold text-gray-800 border-b border-gray-100" onClick={() => setMobileMenuOpen(false)}>Combo</Link>
          </div>
...
const Hero = () => {
  ...
  const heroSlides = [
    ...
    {
      type: 'image',
      src: "https://cdn.ddecor.com/media/mageplaza/bannerslider/banner/image/b/e/bedding-combo_1920x1080-pix.jpg",
      category: "BEDDING COMBO",
      title: "Complete bedding sets curated for your comfort and style.",
      buttonText: "EXPLORE COLLECTION"
    },
    {
      type: 'image',
      src: "https://cdn.ddecor.com/media/mageplaza/bannerslider/banner/image/k/i/kilim_1920x1080-pix_1.jpg",
      category: "KILIM COLLECTION",
      title: "Traditional Kilim patterns reimagined for modern interiors.",
      buttonText: "DISCOVER MORE"
    },
    {
      type: 'image',
    ...
    {
      type: 'image',
      src: "https://cdn.ddecor.com/media/mageplaza/bannerslider/banner/image/a/f/african-vibes_theme_1920x1080-pix.jpg",
      category: "AFRICAN VIBES",
      title: "Bold patterns and earthy tones inspired by African artistry.",
      buttonText: "SHOP NOW"
    },
    {
      type: 'image',
      src: "https://cdn.ddecor.com/media/mageplaza/bannerslider/banner/image/s/a/sandscape_1.jpg",
      category: "SANDSCAPE COLLECTION",
      title: "Serene desert-inspired textures for peaceful living spaces.",
      buttonText: "VIEW COLLECTION"
    },
    {
      type: 'image',
      src: "https://cdn.ddecor.com/media/mageplaza/bannerslider/banner/image/e/v/evaryday-luxe_1920x1080-pix_1.jpg",
      category: "EVERYDAY LUXE",
      title: "Affordable luxury for everyday elegance in your home.",
      buttonText: "SHOP NOW"
    },
    // New Landing Images
    {
      type: 'image',
      src: "/landing1.png",
      category: "ARVIND COLLECTION",
      title: "Premium textiles crafted with passion and precision.",
      buttonText: "EXPLORE"
    },
    {
      type: 'image',
      ...
      title: "Transform your living spaces with our curated collections.",
      buttonText: "SHOP NOW"
    },
    {
      type: 'image',
      src: "/landing3.png",
      category: "DESIGNER RANGE",
      title: "Where tradition meets contemporary design excellence.",
      buttonText: "DISCOVER"
    },
    {
      type: 'image',
      ...
      title: "Handcrafted perfection for the discerning home.",
      buttonText: "EXPLORE"
    },
    {
      type: 'image',
      ...
      title: "Bring warmth and comfort to every room.",
      buttonText: "SHOP NOW"
    },
    {
      type: 'image',
      src: "/landing7.png",
      category: "HERITAGE RANGE",
      title: "Timeless elegance rooted in centuries of tradition.",
      buttonText: "DISCOVER"
    }
  ];
      ...
      <div className="relative z-10 max-w-[1600px] w-full px-6 md:px-12 lg:px-20">
        <div className="max-w-2xl">
          ...
          <div className="animate-slideUp opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            <button className="bg-[#9f1b3c] text-white px-6 md:px-10 py-3 md:py-4 text-xs md:text-xs font-bold font-source uppercase tracking-[0.2em] hover:bg-white hover:text-[#9f1b3c] border-2 border-[#9f1b3c] transition-all duration-300 shadow-lg">
...
const Collections = () => {
  ...
  const categories = [
    // BED Categories
    { id: 1, name: "Bedsheet", image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=800", slug: "bedsheet", type: "BED" },
    { id: 2, name: "Comforter", image: "https://images.unsplash.com/photo-1615529182904-14819c35db37?auto=format&fit=crop&q=80&w=800", slug: "comforter", type: "BED" },
    { id: 3, name: "Dohar", image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80&w=800", slug: "dohar", type: "BED" },
    { id: 4, name: "Blanket", image: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&q=80&w=800", slug: "blanket", type: "BED" },
    { id: 5, name: "Pillow", image: "https://images.unsplash.com/photo-1584100936595-c0654b55a2e6?auto=format&fit=crop&q=80&w=800", slug: "pillow", type: "BED" },
    { id: 6, name: "Duvet Cover", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&q=80&w=800", slug: "duvet-cover", type: "BED" },
    // BATH Categories
    { id: 7, name: "Bath Towel", image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=800", slug: "bath-towel", type: "BATH" },
    { id: 8, name: "Hand Towel", image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=800", slug: "hand-towel", type: "BATH" },
    { id: 9, name: "Face Towel", image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=800", slug: "face-towel", type: "BATH" },
    { id: 10, name: "Baby Bath Towel", image: "https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=800", slug: "baby-bath-towel", type: "BATH" }
  ];
    ...
    <section id="collections" className="py-16 bg-white w-full">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex items-center gap-4 mb-10">
          <div className="w-12 h-[3px] bg-[#da1f26]"></div>
          <h2 className="font-garamond italic text-2xl md:text-3xl text-[#064770]">Our Collections</h2>
        </div>
            ...
            {categories.map((category) => (
              ...
              >
                ...
                <div className="bg-white p-4 flex items-center justify-between">
                  <div>
                    <span className="font-source text-xs uppercase tracking-widest text-[#da1f26] block mb-1">{category.type}</span>
...
const FeaturedCollection = () => {
  ...
  const products = [
    {
      id: 1,
      title: 'NEW COLLECTION SIGNATURE',
      description: 'Exclusive new arrival featuring contemporary designs with premium craftsmanship.',
      image: '/newcollection1.png'
    },
    {
      id: 2,
      title: 'NEW COLLECTION PREMIUM',
      description: 'Luxurious new addition to our collection, crafted with the finest materials.',
      image: '/newcollection2.png'
    },
    {
      id: 3,
      title: 'VELVET THROW BLANKET',
      description: 'Premium velvet throw blanket crafted from the finest materials for ultimate comfort.',
      image: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 4,
      title: 'HERITAGE BEDSHEET SET',
      description: 'Egyptian cotton bedsheet set with heritage jacquard patterns woven into the fabric.',
      image: 'https://images.unsplash.com/photo-1615529182904-14819c35db37?auto=format&fit=crop&q=80&w=800'
    }
  ];
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full py-20 bg-[#FDFBF7]"
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            {/* Red Line + Label */}
            <div className="flex items-center gap-4 mb-6">
              <div className="w-8 h-[2px] bg-[#da1f26]"></div>
              <span className="font-source text-xs uppercase tracking-[0.3em] text-gray-500">
                New Collection
              </span>
            </div>

            {/* Title */}
            <h2 className="font-redhat font-bold text-3xl md:text-4xl text-[#064770] mb-6">
              {currentProduct.title}
            </h2>

            {/* Description */}
            <p className="font-source text-gray-600 leading-relaxed mb-8 max-w-md">
            ...
            <button
              ...
              className="bg-[#da1f26] text-white px-8 py-3 text-xs font-bold font-source uppercase tracking-[0.2em] hover:bg-[#b01820] transition-all"
            >
              Discover More
            </button>
          </div>

          {/* Right Side - Image with Arrows */}
          <div className={`relative transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/80 shadow-lg flex items-center justify-center hover:bg-white transition-colors"
            >
              <ChevronLeft size={24} className="text-[#2c2c2c]" />
            </button>
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-white/80 shadow-lg flex items-center justify-center hover:bg-white transition-colors"
            >
              <ChevronRight size={24} className="text-[#2c2c2c]" />
            </button>
            ...
            <div className="flex items-center justify-center gap-2 mt-6">
              {products.map((_, idx) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${idx === currentIndex ? 'bg-[#da1f26] w-6' : 'bg-gray-300 w-2'}`}
                />
              ))}
            </div>
          </div>
...
const AboutPage = () => {
  ...
  return (
    <div className="w-full bg-white">
      {/* Hero */}
      <section className="relative pt-32 pb-16 min-h-[40vh] flex items-end">
        {/* Background Image */}
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 w-full">
          ...
          <button
            onClick={() => navigate(-1)}
            className="absolute top-4 left-6 flex items-center gap-2 text-white/80 hover:text-white transition-colors font-source text-sm uppercase tracking-wider"
          >
...
const ShopPage = () => {
  ...
  // Use productsData from global scope and map for shop page
  const allProducts = productsData.map(p => ({
    id: p.id,
    name: p.name,
    price: p.priceFormatted,
    collection: p.technique || 'Arvind',
    image: p.image,
    category: p.category.toLowerCase().replace(/ /g, '-'),
    subcategory: p.category
  }));

  // BED and BATH Category Structure
  const categoryFilters = [
      ...
      children: [
        { 
          ...
          subtypes: [
            { name: 'Print', count: 20 },
            { name: 'Solid', count: 15 },
            { name: 'Digital Print', count: 5 },
            { name: 'Yarn Dyed', count: 1 },
            { name: 'Embroidery', count: 2 }
          ]
        },
        { name: 'Comforter', slug: 'comforter' },
        { name: 'Dohar', slug: 'dohar' },
        { name: 'Pillow Covers', slug: 'pillow-covers' },
        { name: 'Blanket', slug: 'blanket' },
        { name: 'Mosquito Net', slug: 'mosquito-net' },
    ...
    },
    {
      ...
      children: [
        ...
        { name: 'Baby Bath Towel', slug: 'baby-bath-towel' },
        { name: 'Hand Towel', slug: 'hand-towel' },
        { name: 'Face Towel', slug: 'face-towel' },
        { name: 'Combo', slug: 'towel-combo' }
      ]
    }
  ];
  ...
  return (
    <div className="w-full bg-[#f8f6f3] min-h-screen pt-24 md:pt-32">
      {/* Breadcrumb */}
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[1400px] mx-auto px-6 py-4">
          <div className="flex items-center gap-4 max-w-xl mx-auto">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3 font-source text-sm border border-gray-300 rounded-full focus:border-[#9f1b3c] focus:outline-none focus:ring-2 focus:ring-[#9f1b3c]/20 transition-all"
              />
              {searchQuery && (
                <button
          ...
          {searchQuery && (
            <p className="text-center mt-2 font-source text-sm text-gray-500">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <button
            className="lg:hidden w-full py-3 border border-gray-300 flex items-center justify-center gap-2 text-sm font-source font-semibold uppercase tracking-wider hover:border-[#da1f26] hover:text-[#da1f26] transition-colors"
          ...
          {/* Sticky Sidebar - Hidden on mobile unless toggled */}
          <aside className={`w-full lg:w-64 flex-shrink-0 ${showMobileFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="sticky top-24">
              {/* Category Image Display */}
              <div className="mb-6 overflow-hidden rounded-lg">
                <img
                  src={category?.includes('bed') || category?.includes('pillow') || category?.includes('comforter') || category?.includes('dohar') || category?.includes('blanket') || category?.includes('mosquito') || category?.includes('duvet')
                    ? 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=400'
                    : category?.includes('towel') || category?.includes('bath')
                      ? 'https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80&w=400'
                      : 'https://images.unsplash.com/photo-1518882605630-8b11a9677e7c?auto=format&fit=crop&q=80&w=400'
                  }
                  alt={`${category || 'All'} collection`}
                  className="w-full h-40 object-cover"
                />
                <div className="text-center py-2 bg-[#FDFBF7]">
                  <span className="font-source text-xs text-gray-500 uppercase tracking-wider">
                    {category?.includes('bed') || category?.includes('pillow') || category?.includes('comforter') || category?.includes('dohar') || category?.includes('blanket') || category?.includes('mosquito') || category?.includes('duvet')
                      ? '🛏️ BED Collection'
                      : category?.includes('towel') || category?.includes('bath')
                        ? '🛁 BATH Collection'
                        : '🏠 All Products'}
                      ...
                      {categoryFilters.map((cat) => (
                        <div key={cat.slug} className="mb-3">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-source font-bold text-sm text-[#9f1b3c] uppercase">{cat.name}</span>
                          </div>
                          <div className="ml-6 space-y-1 border-l-2 border-[#da1f26]/20 pl-3">
                            {cat.children.map((child: any, idx: number) => (
                              <div key={idx}>
                                <Link
                                  to={`/shop/${child.slug}`}
                                  className={`block text-sm font-source py-1 ${category === child.slug ? 'text-[#da1f26] font-semibold' : 'text-gray-600 hover:text-[#da1f26]'}`}
                                >
                                  {child.name}
                                </Link>
                                {child.subtypes && category === child.slug && (
                                  <div className="ml-4 space-y-1">
                                    {child.subtypes.map((sub: any, subIdx: number) => (
                                      <button
                                        key={subIdx}
                                        className="block text-xs font-source text-gray-500 hover:text-[#da1f26] py-0.5"
                                      >
                                        {sub.name} {sub.count && <span className="text-gray-400">({sub.count})</span>}
                                      </button>
                                    ))}
                                  </div>
                                )}
...
const Footer = () => {
  return (
    <footer className="bg-[#9f1b3c] text-white pt-16 md:pt-24 pb-12 w-full">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-20">
          <div className="md:col-span-1">
            {/* Wordmark Footer */}
            <span className="font-redhat font-bold text-3xl tracking-tight block mb-6">Arvind</span>
            <p className="font-source text-white leading-relaxed text-sm">
              Fashioning Possibilities since 1931. A multi-sectoral business with seven decades of heritage and a vision for tomorrow.
            </p>
          </div>

          <div>
            <h4 className="font-source font-bold text-xs uppercase tracking-widest mb-8 text-white">Collections</h4>
          ...
          <div>
            <h4 className="font-source font-bold text-xs uppercase tracking-widest mb-8 text-white">Company</h4>
            <ul className="space-y-4 font-source text-sm text-gray-300">
              <li><a href="https://www.arvind.com/arvind-story" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">The Arvind Story</a></li>
          ...
          <div>
            <h4 className="font-source font-bold text-xs uppercase tracking-widest mb-8 text-white">Sustainability</h4>
            <ul className="space-y-4 font-source text-sm text-gray-300">
              <li><a href="https://www.arvind.com/sustainability" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Sustainability</a></li>
              <li><a href="https://www.arvind.com/environment" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Environment</a></li>
              <li><a href="https://www.arvind.com/social" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Social</a></li>
              <li><a href="https://www.arvind.com/governance" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Governance</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-source font-bold text-xs uppercase tracking-widest mb-8 text-white">Follow Us</h4>
            <div className="flex gap-6 mb-8">
              <Instagram size={20} className="text-white hover:text-white cursor-pointer transition-colors" />
              <Facebook size={20} className="text-white hover:text-white cursor-pointer transition-colors" />
              <Twitter size={20} className="text-white hover:text-white cursor-pointer transition-colors" />
              <Linkedin size={20} className="text-white hover:text-white cursor-pointer transition-colors" />
            </div>
...
// --- PAGE SPLASH WRAPPER (for internal pages) ---
const PageSplashWrapper = ({ children, pageName }: { children: ReactNode; pageName: string }) => {
  const [showSplash, setShowSplash] = useState(true);
  const [isExiting, setIsExiting] = useState(false);
  const [contentVisible, setContentVisible] = useState(false);

  useEffect(() => {
    // After 2 seconds, start exit animation (shorter for page transitions)
    const exitTimer = setTimeout(() => {
      setIsExiting(true);
    }, 2000);

    // After exit animation (800ms), hide splash and show content
  ...
  return (
    <>
      ...
      {showSplash && (
        <div
          className={`fixed inset-0 z-[10000] flex flex-col items-center justify-center ${isExiting ? 'splash-exit' : ''}`}
          style={{ backgroundColor: '#9f1b3c' }}
        >
          {/* Logo Text - slides from right to left */}
          <h1
            className="splash-text-right-to-left font-garamond text-5xl md:text-7xl text-white tracking-wider"
            style={{ animationDelay: '0.1s' }}
          >
            Arvind
          </h1>

          {/* Tagline - slides from left to right */}
          <p
            className="splash-text-left-to-right font-source text-sm md:text-base text-white uppercase tracking-[0.4em] mt-4"
            ...
            <div className="w-full min-h-screen flex flex-col relative">
              ...
              <main className="flex-grow">
                <Routes>
                  ...
                  <Route path="/about" element={<PageSplashWrapper pageName="About Us"><AboutPage /></PageSplashWrapper>} />
                  <Route path="/businesses" element={<PageSplashWrapper pageName="Our Businesses"><BusinessesPage /></PageSplashWrapper>} />
                  <Route path="/sustainability" element={<PageSplashWrapper pageName="Sustainability"><SustainabilityPage /></PageSplashWrapper>} />
                  <Route path="/innovation" element={<PageSplashWrapper pageName="Innovation"><InnovationPage /></PageSplashWrapper>} />
                  <Route path="/careers" element={<PageSplashWrapper pageName="Careers"><CareersPage /></PageSplashWrapper>} />
